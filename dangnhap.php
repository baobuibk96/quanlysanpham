    ...
    <table width="302" border="1">
      ...
      <tr>
        <td colspan="2">
			...
			<a href="dangnhapadmin.html" style="display: inline-block; padding: 6px;"><strong>Đăng nhập admin</strong></a>
		</td>
        <!-- <td colspan="1" style="align-items: center;">
			<label>
				<a href="dangnhapadmin.html">Đăng nhập admin</a>
			</label>
		</td> -->
      </tr>
      </table>
